...
@interface SDStatusBarOverriderPre8_3()
{
  NSDictionary* m_iconMapping;
}
...
- (void)setIcon:(NSInteger)icon hidden:(BOOL)hidden;
{
  ...
  NSNumber* mappedIcon = [m_iconMapping objectForKey:@(icon)];
  ...
  overrides->booloverrideItemIsEnabled[mappedIcon.intValue] = !hidden;
  overrides->values.boolitemIsEnabled[mappedIcon.intValue] = !hidden;
